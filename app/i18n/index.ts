...
const KATALOGE: Record<Locale, Katalog> = {
  de: { ...de_common, ...de_navigation, ...de_search, ...de_property, ...de_listing, ...de_account, ...de_konto, ...de_favoriten, ...de_verlauf, ...de_vergleich, ...de_anfragen, ...de_anbieter, ...de_org, ...de_anliegen, ...de_service },
  fr: { ...fr_common, ...fr_navigation, ...fr_search, ...fr_property, ...fr_listing, ...fr_account, ...fr_konto, ...fr_favoriten, ...fr_verlauf, ...fr_vergleich, ...fr_anfragen, ...fr_anbieter, ...fr_org, ...fr_anliegen, ...fr_service },
  it: { ...it_common, ...it_navigation, ...it_search, ...it_property, ...it_listing, ...it_account, ...it_konto, ...it_favoriten, ...it_verlauf, ...it_vergleich, ...it_anfragen, ...it_anbieter, ...it_org, ...it_anliegen, ...it_service },
  en: { ...en_common, ...en_navigation, ...en_search, ...en_property, ...en_listing, ...en_account, ...en_konto, ...en_favoriten, ...en_verlauf, ...en_vergleich, ...en_anfragen, ...en_anbieter, ...en_org, ...en_anliegen, ...en_service }
};
