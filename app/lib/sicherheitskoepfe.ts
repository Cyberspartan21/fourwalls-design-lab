...
/* ---------- Content-Security-Policy — aus den tatsächlichen Quellen gebaut (P5.5 §56) ----------
   - Schriften (Petrona, Manrope) und MapLibre GL (Skript + Stylesheet) werden
     seit P5.9 Entscheid 23 selbst gehostet (public/fonts, npm-Abhängigkeit
     maplibre-gl) — kein fonts.googleapis.com/fonts.gstatic.com/cdnjs mehr.
